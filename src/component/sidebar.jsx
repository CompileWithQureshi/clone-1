        ...
        <div>
          ...
          <div
            className="  border border-white 
             "
          >
            <ul className=" pb-28 flex   leading-3 text-sm flex-col justify-between content-between     ">
            ...
            <div className="flex items-center border-t-2 p-2 mt-12 space-x-4  bg-blue-400 ">
              <img
